                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            ...
                                            <form class="form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                                                <div class="form-body">
                                                    <h4 class="form-section"><i class="ft-home"></i>Add Admin
                                                    </h4>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="name_ar"> Name </label>
                                                                <input type="text" id="name_ar" class="form-control" placeholder="Enter Name Of Admin" name="name">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" id="email" class="form-control" placeholder="Enter The Email" name="email">
                                                                <span class="text-danger errors">
                                                                    <?php
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="address" class="form-control" placeholder="Enter The Admin Address" name="address">
                                                                <span class="text-danger errors">
                                                                    <?php
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="description" class="form-control" placeholder="Enter the admin's address" name="description">
                                                                <span class="text-danger errors">
                                                                    <?php
