...
//update the category commands
        $query = "update categories set name='$name',description='$description' where id =" . $_GET['id'];
...
//getting the category id from url
if (isset($_GET['id'])) {
    $id = $_GET['id'];
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class=" col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="projectinput2" name="c_description" placeholder="Category Description" type="text" value="<?php
